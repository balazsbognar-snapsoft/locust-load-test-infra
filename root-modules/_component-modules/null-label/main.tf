## This code is forked from  https://github.com/cloudposse/terraform-null-label
locals {

  defaults = {
    # The `resource_type` label was introduced by sre in place of tenant
    label_order         = ["namespace", "environment", "stage", "name", "resource_type", "attributes"]
  ...
  input = {
    ...
    # resource_type was introduced in v0.25.0, prior context versions do not have it
    resource_type = var.resource_type == null ? lookup(var.context, "resource_type", null) : var.resource_type
  ...
  string_label_names = ["namespace", "resource_type", "environment", "stage", "name"]
  ...
  resource_type = local.formatted_labels["resource_type"]
